  ...
  return (
    <div className="dark:bg-[#050505] bg-white min-h-screen">
      ...
      <div className="pt-48 px-4 sm:px-18 md:px-32">
        ...
        <div className="p-2 pr-[15vw] text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-white">
        ...
        <div className="pl-2">
          <Link href="/code-review">
            <button className="border border-[#00000069] dark:border-[#fff6] dark:text-white p-2 px-4 rounded
            hover:bg-gray-300 hover:border-[#fff] dark:hover:bg-[#1c1c1c]">
              Review Code
            </button>
          </Link>
        </div>
